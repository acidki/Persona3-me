...
const ITEMS = [
  ...
  { id: "github",  label: "GITHUB LINK",   page: "github",  href: "https://github.com/acidki", fontSize: 68, offsetX: 8, offsetY: 6,  skew: 0, skewY: -4  },
...
export default function P3Menu({ onNavigate }) {
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Enter")     ITEMS[active].href ? window.open(ITEMS[active].href, "_blank", "noopener,noreferrer") : onNavigate?.(ITEMS[active].page);
    };
          ...
          {ITEMS.map((item, i) => {
            ...
            return (
              <a
                ...
                onClick={(e) => { e.preventDefault(); item.href ? window.open(item.href, "_blank", "noopener,noreferrer") : onNavigate?.(item.page); }}
